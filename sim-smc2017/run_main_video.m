...
% export ROS_MASTER_URI=http://128.46.80.238:11311
% export ROS_IP=128.46.80.235
...
% setenv('ROS_MASTER_URI','http://128.46.80.238:11311') % ROS MASTER IP
% setenv('ROS_IP','128.46.80.235') % MATLAB IP
% rosinit
