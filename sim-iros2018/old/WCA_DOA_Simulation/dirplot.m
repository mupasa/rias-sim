...
%xlabel('Direction of Arrival (DoA) Estimation /dBm');
%text(-24,-2,'Direction of Arrival (DoA) Estimation /dBm'); %for small plot
%text(-18,-2,'Direction of Arrival (DoA) Estimation /dBm'); %for big plot
