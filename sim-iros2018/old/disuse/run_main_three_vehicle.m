...
cmdvelpub = rospublisher('h1/husky_velocity_controller/cmd_vel', 'geometry_msgs/Twist');
cmdvelmsg = rosmessage(cmdvelpub);

cmdvelpub_1 = rospublisher('h2/husky_velocity_controller/cmd_vel', 'geometry_msgs/Twist');
cmdvelmsg_1 = rosmessage(cmdvelpub_1);

cmdvelpub_2 = rospublisher('h3/husky_velocity_controller/cmd_vel', 'geometry_msgs/Twist');
cmdvelmsg_2 = rosmessage(cmdvelpub_2);

% Subscribe to the topic for ROS
odomsub = rossubscriber('h1/husky_velocity_controller/odom');

odomsub_1 = rossubscriber('h2/husky_velocity_controller/odom');

odomsub_2 = rossubscriber('h3/husky_velocity_controller/odom');
