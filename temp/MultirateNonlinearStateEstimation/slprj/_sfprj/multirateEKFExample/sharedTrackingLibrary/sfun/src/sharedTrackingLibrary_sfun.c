  ...
  unsigned int chartFileNumber, const char* specsCksum, int_T method, void *data)
{
  if (chartFileNumber==8) {
    if (!strcmp(specsCksum, "sL5XorzCIaSBHWWbjdvvUSD")) {
      c8_sL5XorzCIaSBHWWbjdvvUSD_sharedTrackingLibrary_method_dispatcher
  ...
  if (nrhs>2 && mxIsChar(prhs[1])) {
    ...
    if (!strcmp(commandName,"library")) {
      ...
      if (!strcmp(machineName,"sharedTrackingLibrary")) {
        if (nrhs==3) {
          ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1185367936U);
          ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2668742707U);
          ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3080228717U);
          ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(766049262U);
        } else if (nrhs==4) {
          ...
          switch (chartFileNumber) {
           case 8:
            {
              extern void
                sf_c8_sL5XorzCIaSBHWWbjdvvUSD_sharedTrackingLibrary_get_check_sum
                (mxArray *plhs[]);
              sf_c8_sL5XorzCIaSBHWWbjdvvUSD_sharedTrackingLibrary_get_check_sum
                (plhs);
              break;
  ...
  plhs[], int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 8:
      {
        if (strcmp(aiChksum, "1FfrySwIiTJVLfzEZ106VD") == 0) {
          extern mxArray
     ...
     case 9:
      {
        if (strcmp(aiChksum, "uWejKQAjC0E65GdpLd4UjE") == 0) {
  ...
  mxArray * plhs[], int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 8:
      {
        if (strcmp(instanceChksum, "sL5XorzCIaSBHWWbjdvvUSD") == 0) {
     ...
     case 9:
      {
        if (strcmp(instanceChksum, "soBm4wuxY6nhdNo4dLNwMxC") == 0) {
          extern const mxArray
  ...
  plhs[], int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 8:
      {
        if (strcmp(tpChksum, "sL5XorzCIaSBHWWbjdvvUSD") == 0) {
          extern mxArray
     ...
     case 9:
      {
        if (strcmp(tpChksum, "soBm4wuxY6nhdNo4dLNwMxC") == 0) {
     ...
     case 8:
      {
        if (strcmp(tpChksum, "sL5XorzCIaSBHWWbjdvvUSD") == 0) {
          extern mxArray
            *sf_c8_sL5XorzCIaSBHWWbjdvvUSD_sharedTrackingLibrary_jit_fallback_info
            (void);
          plhs[0] =
            sf_c8_sL5XorzCIaSBHWWbjdvvUSD_sharedTrackingLibrary_jit_fallback_info
            ();
  ...
  boolean_T isModelRef, boolean_T isExternal)
{
  ...
  if (sRtwOptimizationInfoStruct==NULL) {
    sRtwOptimizationInfoStruct = sf_load_rtw_optimization_info(
      "sharedTrackingLibrary", "multirateEKFExample");
