#ifndef __sharedTrackingLibrary_sfun_h__
#define __sharedTrackingLibrary_sfun_h__
...
extern uint32_T _sharedTrackingLibraryMachineNumber_;
...
extern mxArray* load_sharedTrackingLibrary_optimization_info(boolean_T isRtwGen,
  boolean_T isModelRef, boolean_T isExternal);
extern void unload_sharedTrackingLibrary_optimization_info(void);
