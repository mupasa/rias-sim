...
unsigned int sf_process_check_sum_call( int nlhs, mxArray * plhs[], int nrhs,
  const mxArray * prhs[] )
{
  extern unsigned int sf_multirateEKFExample_process_check_sum_call( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  extern unsigned int sf_sharedTrackingLibrary_process_check_sum_call( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_multirateEKFExample_process_check_sum_call(nlhs,plhs,nrhs,prhs))
    return 1;
...
{
  extern unsigned int sf_multirateEKFExample_autoinheritance_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  ...
  if (strcmp(machineName, "multirateEKFExample") == 0) {
    const mxArray *newRhs[3] = { NULL, NULL, NULL };

    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_multirateEKFExample_autoinheritance_info(nlhs,plhs,3,newRhs);
  }
...
{
  extern unsigned int sf_multirateEKFExample_third_party_uses_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  ...
  if (strcmp(machineName, "multirateEKFExample") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_multirateEKFExample_third_party_uses_info(nlhs,plhs,3,newRhs);
  }
...
{
  extern unsigned int sf_multirateEKFExample_jit_fallback_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  ...
  if (strcmp(machineName, "multirateEKFExample") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_multirateEKFExample_jit_fallback_info(nlhs,plhs,3,newRhs);
  }
...
unsigned int sf_process_get_updateBuildInfo_args_info_call( int nlhs, mxArray *
  plhs[], int nrhs, const mxArray * prhs[] )
{
  extern unsigned int sf_multirateEKFExample_updateBuildInfo_args_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  ...
  if (strcmp(machineName, "multirateEKFExample") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_multirateEKFExample_updateBuildInfo_args_info(nlhs,plhs,3,newRhs);
  }
...
unsigned int sf_process_get_eml_resolved_functions_info_call( int nlhs, mxArray *
  plhs[], int nrhs, const mxArray * prhs[] )
{
  extern unsigned int sf_multirateEKFExample_get_eml_resolved_functions_info
  ...
  if (strcmp(machineName, "multirateEKFExample") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_multirateEKFExample_get_eml_resolved_functions_info(nlhs,plhs,3,
      newRhs);
  }
...
extern unsigned int sf_multirateEKFExample_method_dispatcher(SimStruct *S,
...
unsigned int sf_machine_global_method_dispatcher(SimStruct *simstructPtr, const
  ...
  method, void *data)
{
  if (!strcmp(machineName,"multirateEKFExample")) {
    return(sf_multirateEKFExample_method_dispatcher(simstructPtr,chartFileNumber,
...
extern void multirateEKFExample_terminator(void);
...
void sf_machine_global_terminator(SimStruct* S)
{
  ...
  if (sfGlobalMdlStartCallCounts == 0) {
    multirateEKFExample_terminator();
...
extern void multirateEKFExample_initializer(void);
extern void sharedTrackingLibrary_initializer(void);
extern void multirateEKFExample_register_exported_symbols(SimStruct* S);
extern void sharedTrackingLibrary_register_exported_symbols(SimStruct* S);
extern void multirateEKFExample_debug_initialize(struct SfDebugInstanceStruct*);
...
{
  multirateEKFExample_register_exported_symbols(S);
...
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if (sfGlobalMdlStartCallCounts == 1) {
    ...
    if (!simModeIsRTWGen) {
      multirateEKFExample_debug_initialize(sfGlobalDebugInstanceStruct);
    }

    multirateEKFExample_initializer();
    if (!simModeIsRTWGen) {
